...
public class FlatVirtualComponentVirtualFolder extends PartialReadOnlyVirtualFolder {
	...
	private IVirtualReference createReference(IFlatFile flatFile) {
		...
		if (file != null && file.exists()) {
			...
			VirtualArchiveComponent referencedComponent = new VirtualArchiveComponent(getProject(), archiveLocation, runtimePath);
			
			IVirtualReference virtualReference = ComponentCore.createReference(flatVirtualComponent.getComponent(), referencedComponent);
